...
<template>
    <header class="container-header" :class="{hide: hide}">
        <div class="principal">
            ...
            <div class="group">
                <div class="pesquisa" :class="{focus:inputFocus}">
                    ...
                    <input type="text" placeholder="Pesquisar" :value="pesquisa" @input="buscarUsuarios"
        ...
        <div class="resultado" v-if="resultado.length > 0">
            <ResultadoBusca v-for="user in resultado" :key="user._id" :id="user._id" :nome="user.nome"
